...
import com.jz.service.impl.BaseUserDetailServiceImpl;
import com.jz.token.JwtAccessToken;
import com.jz.utils.BCryptUtil;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
     ...
     * @throws Exception 配置令牌 管理 (jwtAccessTokenConverter)
     */
    @Override
    ...
    /**
     * @param clientDetailsServiceConfigurer ClientDetailsServiceConfigurer：用来配置客户端详情服务（ClientDetailsService）
...
//        client_id: 用来标识客户的Id。第三方用户的id（可理解为账号）
                .withClient("test")
                .redirectUris("http://www.baidu.com","http://localhost:9002")
//        client_secret:第三方应用和授权服务器之间的安全凭证(可理解为密码)
                //（需要值得信任的客户端）客户端安全码
                .secret(BCryptUtil.encoder("test"))
...
//                .scopes("app");
    ...
    /**
     * @param security AuthorizationServerSecurityConfigurer：用来配置令牌端点(Token Endpoint)的安全约束
     * @throws Exception
     */
    @Override
